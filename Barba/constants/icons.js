...
const arrowLeftt = require("../assets/icons/arrow-left.png"); 
...
const list = require("../assets/category/Almond 3D Model.png");
const heartPulse = require("../assets/category/Beach Chair.png");
const cupStraw= require("../assets/category/Educational Video.png");
const shieldCheck= require("../assets/category/Sofa 3D Model.png");
const brush= require("../assets/category/Hotdog.png");
const geoAlt= require("../assets/category/Image Editing Interface 3D Model.png");
const bagHeart= require("../assets/category/Lipstick.png");
const book= require("../assets/category/Money Insurance.png");
const houseDoor= require("../assets/category/Online Doctor Consultation.png");
const truck= require("../assets/category/Oral Health Day.png");
const display = require("../assets/category/Ticket.png");
const moto = require("../assets/category/Electric Motorcycle.png");
